...
In order for initiatives to be succcessful, financial support will need to come from other sources: academia, public and private sector, and philanthropic. To date there are numerous NGOs working throughout the world to beat poverty and reduce disease. The United Nations started and initiative in 2009 called Global Pulse the objective of which is to establish research laboratories to study methologies in which data science can be incorporated through the developing world to improve lives. Several private organizations are also playing a role. For example, Google has announced a plan to develop high speed internet solutions in developing countries using high altitude ballons. Their goal is to add an additional 1 million people to the Internet from Africa,  and Southwest Asia \cite{DevEcon}. 
