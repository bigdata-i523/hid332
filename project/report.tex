...
Hundreds of thousands of dollars are spent on cancer care. Big data can be used to develop individualized, personalized cancer care programs. There is a web based application, which was sponsored by the National Cancer Institute that uses data from the Prostate, Lung, Colorectal, and Ovarian Cancer Screening trial together with patient risk factor and demographic data to help develop patient specific treatment regimens \cite{www-google-datapine}. 
...
The trend towards pay for performance reimbursement agreements will also help the cost transparency issue.  This is because these pricing structures encourage health care providers to share information \cite{www-google-christian} \cite{www-google-wall}. 
